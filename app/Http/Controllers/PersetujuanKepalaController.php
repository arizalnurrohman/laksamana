...
class PersetujuanKepalaController extends Controller
{
    ...
    public function edit($id){
        ...
        $residensial = Residensial::select("laksa_tr_layanan.id as residensial_id","laksa_tr_layanan.*","laksa_ms_ppks.*","laksa_ms_sumber_rujukan.*","laksa_ms_petugas_layanan.*","laksa_ms_pegawai.*","laksa_ms_status.*","laksa_ms_gedung.*","laksa_ms_pengampu.*");
