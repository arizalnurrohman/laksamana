        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add{{ $activeMenu->access }}Form">
                    <div class="mb-3">
                        <label for="status_usulan" class="form-label">Status</label>
                        <input type="text" class="form-control" id="status_usulan" name="status_usulan" required>
                    </div>
            ...
            <div class="modal-body">
                <form id="updateForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="updateStatus" name="status_usulan" required>
                    </div>
                    <div class="mb-3">
...
<script>
    function load_this_data(){
        loadTabelData("list-data", "{{route('load_status')}}", ['No', 'Status','Urutan','Aksi']);
    }
    $(document).ready(function () {
        ...
        $('#updateForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route("status_usulan.update") }}',
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    id: $('#updateId').val(),
                    status_usulan: $('#updateStatus').val(),
                },
                success: function (response) {
                    Swal.fire({
                        icon    : 'success',
