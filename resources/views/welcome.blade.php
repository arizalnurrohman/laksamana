                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="message" class="form-control w-100" placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit">
                            </div>
                        </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center gap-3">
                    <img class="img-fluid rounded-circle avatar-130" src="../blog/assets/images/blog-avatar/01.png" alt="user-img">
                    <div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <img class="img-fluid fit-img mb-4 object-cover iq-recent-post w-100" src="../blog/assets/images/blog-detail/05.png" alt="01" loading="lazy">
                    <small class="text-primary">April 19th 2021</small>
                    <a href="../blog/blog-detail.html" class="iq-title">
                        <h4 class="mt-2 mb-3">5 Beauty Essentials Everyone Should Have in Their Collection.</h4>
                    </a>
                    <div class="d-flex gap-2">
                        <a href="../blog/blog-dashboard.html" class="text-body">Travel</a><span> | </span>
                        <a href="../blog/blog-dashboard.html" class="text-primary">Jenny Wilson</a>
                    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="iq-col-masonry logik-blogtag list-unstyled gap-3">
                    <li>
                        <a href="javascript:void(0)" class="bg-primary-subtle rounded-pill iq-custom-badge">
                            <span>#Care</span>
                        </a>
                    </li>
                    <li>
